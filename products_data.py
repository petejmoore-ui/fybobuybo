# ---------------- ENHANCED PRODUCTS DATA (2026) ---------------- #
# Manual fields for complete control over product presentation
...
PRODUCTS = [
    {
        ...
        "manual_price": "£16.95",  # Use UK format: £XX.XX
        "manual_rating": "4.6",     # Out of 5
        "manual_reviews": "28,453", # Total review count
    ...
    
    {
        ...
        "manual_price": "£24.99",
        "manual_rating": "4.7",
        "manual_reviews": "12,891",
        
        "keywords": ["hydrogel mask", "collagen", "glass skin", "Korean skincare", "pore minimizing"],
        "pain_points": ["enlarged pores", "loss of elasticity", "dehydrated skin"],
        "benefits": ["overnight glow", "tightened pores", "plump skin", "spa-quality"],
        "price_tier": "premium",
        
        "highlights": [
            "4-pack of professional-grade hydrogel masks",
            "Low-molecular collagen penetrates deep into skin",
            "Ultra-thin sheet adheres perfectly to facial contours",
            "Visible results in just one use",
            "Perfect for special occasions or weekly pampering"
        ],
    ...
    
    {
        ...
        "manual_price": "£199.99",
        "manual_rating": "4.8",
        "manual_reviews": "34,762",
        
        "keywords": ["air fryer", "dual zone", "healthy cooking", "family meals", "Ninja"],
        "pain_points": ["unhealthy frying", "slow cooking", "limited oven space"],
        "benefits": ["healthier meals", "faster cooking", "versatile", "energy efficient"],
        "price_tier": "premium investment",
        
        "highlights": [
            "9.5L capacity feeds family of 6",
            "Dual zone technology - cook mains and sides together",
            "Sync finish ensures both baskets finish simultaneously",
            "75% less fat than traditional deep frying",
            "6 cooking functions: Air Fry, Max Crisp, Roast, Bake, Reheat, Dehydrate"
        ],
        
        "faqs": [
            {
                "q": "Can I cook different foods at different temperatures?",
                "a": "Yes! Each zone has independent temperature controls, perfect for cooking a main and side dish simultaneously."
            },
            {
                "q": "Is it difficult to clean?",
                "a": "Both cooking baskets and crisper plates are dishwasher safe, making cleanup effortless."
            }
        ],
    ...
    # Continue with rest of products...
    # (I'll include a few more examples with varying levels of manual data)
...

    {
        ...
        "url": f"https://amzn.to/3Yq324j?tag=whoaccepts-21",
    ...
    },
    {
        ...
        "url": f"https://amzn.to/3LpASn2?tag=whoaccepts-21",
    ...
    },
    {
        ...
        "url": f"https://amzn.to/3L9rfZK?tag=whoaccepts-21",
    ...
    },
    {
        ...
        "url": f"https://amzn.to/4sAitou?tag=whoaccepts-21",
    ...
    },
    {
        ...
        "url": f"https://amzn.to/49iIrnF?tag=whoaccepts-21",
    ...
    },
    {
        ...
        "url": f"https://amzn.to/4aFtmia?tag=whoaccepts-21",
    ...
    },
    {
        ...
        "url": f"https://amzn.to/49aRqZj?tag=whoaccepts-21",
    ...
    },
    {
        ...
        "url": f"https://amzn.to/3YmhASv?tag=whoaccepts-21",
    ...
    },
    {
        ...
        "url": f"https://amzn.to/3KY1nzY?tag=whoaccepts-21",
    ...
    },
    {
        ...
        "url": f"https://amzn.to/49fdWif?tag=whoaccepts-21",
    ...
    },
    {
        ...
        "url": f"https://amzn.to/49fUmCp?tag=whoaccepts-21",
    ...
    },
    {
        ...
        "url": f"https://amzn.to/3YilDiF?tag=whoaccepts-21",
    ...
    },
    {
        ...
        "url": f"https://amzn.to/3L8maAQ?tag=whoaccepts-21",
    ...
    },
    {
        ...
        "url": f"https://amzn.to/3MZhjCD?tag=whoaccepts-21",
    ...
    },
    {
        ...
        "url": f"https://amzn.to/3KTbvKj?tag=whoaccepts-21",
    ...
    },
    {
        ...
        "url": f"https://amzn.to/48Ylszg?tag=whoaccepts-21",
    ...
    },
    {
        ...
        "url": f"https://amzn.to/4pWqfaj?tag=whoaccepts-21",
    ...
    },
    {
        ...
        "url": f"https://amzn.to/4sAOw7R?tag=whoaccepts-21",
    ...
    },
    {
        ...
        "url": f"https://amzn.to/3MZbchx?tag=whoaccepts-21",
    ...
    },
    {
        ...
        "url": f"https://amzn.to/4jguATc?tag=whoaccepts-21",
    ...
    },
    {
        ...
        "url": f"https://amzn.to/3LoiHhx?tag=whoaccepts-21",
    ...
    },
    {
        ...
        "url": f"https://amzn.to/4pjWiQy?tag=whoaccepts-21",
    ...
    },
    {
        ...
        "url": f"https://www.amazon.co.uk/Ibiza-Norfolk-Broads-Bowie-Odyssey/dp/1837733112?tag=whoaccepts-21",
    ...
    },
    {
        ...
        "url": f"https://amzn.to/3YOsC30?tag=whoaccepts-21",
    ...
    },
    {
        ...
        "url": f"https://amzn.to/4jheRDi?tag=whoaccepts-21",
    ...
    },
    {
        ...
        "url": f"https://amzn.to/4jlfWu3?tag=whoaccepts-21",
    ...
    },
    {
        ...
        "url": f"https://amzn.to/4pgyoVU?tag=whoaccepts-21",
    ...
    },
    {
        ...
        "url": f"https://amzn.to/4si7U9k?tag=whoaccepts-21",
    ...
    },
    {
        ...
        "url": f"https://amzn.to/4aBYsaq?tag=whoaccepts-21",
    ...
    },
    {
        ...
        "url": f"https://amzn.to/4avIgaJ?tag=whoaccepts-21",
    ...
    },
    {
        ...
        "url": f"https://amzn.to/48Ysbt5?tag=whoaccepts-21",
    ...
    },
    {
        ...
        "url": f"https://www.amazon.co.uk/Oral-B-Vitality-Toothbrush-Including-Sensitive/dp/B0B18V92KS?tag=whoaccepts-21",
    ...
    },
    {
        ...
        "url": f"https://www.amazon.co.uk/Impossible-Fortune-multi-million-bestselling-Thursday/dp/0241743982?tag=whoaccepts-21",
    ...
    },
    {
        ...
        "url": f"https://www.amazon.co.uk/Catsan-Hygiene-Plus-Litter-White/dp/B001MZV3OO?tag=whoaccepts-21",
    ...
    },
    {
        ...
        "url": f"https://www.amazon.co.uk/HOTHANDS-Hand-Warmers-Pairs-activated/dp/B08GCT8SXZ?tag=whoaccepts-21",
    ...
    },
    {
        ...
        "url": f"https://www.amazon.co.uk/Fitbit-Activity-6-months-Membership-Readiness/dp/B0B6WRFY5S?tag=whoaccepts-21",
    ...
    },
    {
        ...
        "url": f"https://www.amazon.co.uk/WaterWipes-Sensitive-Newborn-Biodegradable-Unscented/dp/B08MXSBRSB?tag=whoaccepts-21",
    ...
    },
    {
        ...
        "url": f"https://www.amazon.co.uk/Mens-Two-Tone-Memory-Foam-Slipper/dp/B07CLXD2V4?tag=whoaccepts-21",
    ...
    },
    {
        ...
        "url": f"https://www.amazon.co.uk/Catching-Reaction-Reactions-Coordination-Christmas/dp/B0FMD3DXPC?tag=whoaccepts-21",
    ...
    },
    {
        ...
        "url": f"https://www.amazon.co.uk/SHOKZ-Headphones-Bluetooth-Earphones-Waterproof-Black/dp/B0CRTM6B55?tag=whoaccepts-21",
    ...
    },
    {
        ...
        "url": f"https://www.amazon.co.uk/UK-Driving-Theory-Test-Kit/dp/B09D84M7C4?tag=whoaccepts-21",
    ...
    },
    {
        ...
        "url": f"https://www.amazon.co.uk/Magnetic-Training-Chesss-Birthdays-Gatherings/dp/B0FMXLG87Y?tag=whoaccepts-21",
    ...
    },
    {
        ...
        "url": f"https://www.amazon.co.uk/Magnesium-Glycinate-Complex-Supplements-Bisglycinate/dp/B0C9VVCL12?tag=whoaccepts-21",
    ...
    },
    {
        ...
        "url": f"https://www.amazon.co.uk/Projector-Portable-Supported-Rotation-Compatible/dp/B0FMR73KL2?tag=whoaccepts-21",
    ...
    },
    {
        ...
        "url": f"https://www.amazon.co.uk/Kids-Karaoke-Machine-Birthday-Girls-Pink/dp/B0DK4NL37F?tag=whoaccepts-21",
    ...
    },
    {
        ...
        "url": f"https://www.amazon.co.uk/LOreal-Paris-Revitalift-Pro-Xylane-Anti-Ageing/dp/B00SNOAZM8?tag=whoaccepts-21",
    ...
    },
    {
        ...
        "url": f"https://www.amazon.co.uk/Amazon-Fire-TV-Stick-4K/dp/B08XVYZ1Y5?tag=whoaccepts-21",
    ...
    # You can add manual fields to any product, or leave them out to use API/AI generation
]
