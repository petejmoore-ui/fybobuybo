...
.grid{display:grid;grid-template-columns:repeat(auto-fit,minmax(280px,1fr));gap:24px;max-width:1400px;margin:0 auto;padding:0 20px;box-sizing:border-box}
.card{background:{{card}};border-radius:22px;padding:20px;text-align:center;box-shadow:0 20px 40px rgba(0,0,0,.6);transition:transform .3s,box-shadow .3s;margin:0 auto;max-width:100%}
...
@media (max-width:768px){
  ...
  h1, .subtitle{margin-top:24px;margin-bottom:16px;}
