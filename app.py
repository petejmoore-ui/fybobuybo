...
def generate_hook(name):
    try:
        r = client.chat.completions.create(
            ...
            messages=[{
                "role": "user",
                "content": f"Create a unique, exciting 1-2 sentence sales hook for this trending UK Amazon product: '{name}'. Make it urgent and fun. Use <b> tags for bold emphasis (no **). End with a strong call to action like 'Snag it now!' or 'Don't wait!'"
            }],
            temperature=1.0,
            max_tokens=90
        )
